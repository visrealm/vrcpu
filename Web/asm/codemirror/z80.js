...
CodeMirror.defineMode('z80', function(_config, parserConfig) {
  ...
  if (ez80) {
    ...
    keywords1 = /^(exx?|(ld|cp|in)([di]r?)?|mov|jmp|jc|jz|jnc|jnz|pop|push|ad[cd]|cpl|daa|dec|inc|neg|sbc|sub|and|bit|[cs]cf|x?or|res|set|r[lr]c?a?|r[lr]d|s[lr]a|srl|djnz|nop|rst|[de]i|halt|im|ot[di]r|out[di]?)\b/i;
